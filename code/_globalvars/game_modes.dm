GLOBAL_VAR_INIT(master_mode, "warmode") //"extended"
GLOBAL_VAR_INIT(secret_force_mode, "warmode") // if this is anything but "secret", the secret rotation will forceably choose this mode
