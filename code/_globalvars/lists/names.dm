...
GLOBAL_LIST_INIT(golem_names, world.file2list("string/names/golem.txt"))
GLOBAL_LIST_INIT(moth_first, world.file2list("string/names/moth_first.txt"))
GLOBAL_LIST_INIT(moth_last, world.file2list("string/names/moth_last.txt"))
GLOBAL_LIST_INIT(plasmaman_names, world.file2list("string/names/plasmaman.txt"))
GLOBAL_LIST_INIT(ethereal_names, world.file2list("string/names/ethereal.txt"))
...
GLOBAL_LIST_INIT(ooctitle, world.file2list("string/names/roguetown/ooctitle.txt"))
