#define MUSIC_TAV list("Song" = 'sound/music/dreadfulstench.ogg', "Song 2" = 'sound/music/fallenangel.ogg', "Song 3" = 'sound/music/practiceofwar.ogg', "Guide" = 'sound/music/reloading.ogg')
