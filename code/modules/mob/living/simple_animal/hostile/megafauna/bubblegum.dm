...
/datum/action/innate/megafauna_attack/triple_charge
	...
	chosen_message = "<span class='colossus'>I am now triple charging at the target you click on.</span>"
	chosen_attack_num = 1
...
/datum/action/innate/megafauna_attack/hallucination_charge
	...
	chosen_message = "<span class='colossus'>I am now charging with hallucinations at the target you click on.</span>"
	chosen_attack_num = 2
...
/datum/action/innate/megafauna_attack/hallucination_surround
	...
	chosen_message = "<span class='colossus'>I am now surrounding the target you click on with hallucinations.</span>"
	chosen_attack_num = 3
...
/datum/action/innate/megafauna_attack/blood_warp
	...
	chosen_message = "<span class='colossus'>I am now warping to blood around your clicked position.</span>"
	chosen_attack_num = 4
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/proc/bloodsmack(turf/T, handedness)
	...
	for(var/mob/living/L in T)
		if(!faction_check_mob(L))
			to_chat(L, "<span class='danger'>[src] rends you!</span>")
			playsound(T, attack_sound, 100, TRUE, -1)
			var/limb_to_hit = L.get_bodypart(pick(BODY_ZONE_HEAD, BODY_ZONE_CHEST, BODY_ZONE_R_ARM, BODY_ZONE_L_ARM, BODY_ZONE_R_LEG, BODY_ZONE_L_LEG))
			L.apply_damage(10, BRUTE, limb_to_hit, L.run_armor_check(limb_to_hit, "melee", null, null, armor_penetration))
	SLEEP_CHECK_DEATH(3)
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/proc/bloodgrab(turf/T, handedness)
	...
	for(var/mob/living/L in T)
		if(!faction_check_mob(L))
			if(L.stat != CONSCIOUS)
				to_chat(L, "<span class='danger'>[src] drags you through the blood!</span>")
				playsound(T, 'sound/blank.ogg', 100, TRUE, -1)
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/bullet_act(obj/projectile/P)
	if(BUBBLEGUM_IS_ENRAGED)
		visible_message("<span class='danger'>[src] deflects the projectile; [p_they()] can't be hit with ranged weapons while enraged!</span>", "<span class='danger'>I deflect the projectile!</span>")
...
/mob/living/simple_animal/hostile/megafauna/bubblegum/Bump(atom/A)
	if(charging)
		...
		if(isliving(A))
			var/mob/living/L = A
			L.visible_message("<span class='danger'>[src] slams into [L]!</span>", "<span class='danger'>[src] tramples you into the ground!</span>")
