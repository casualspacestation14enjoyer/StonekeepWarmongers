...
/datum/action/innate/elite_attack/herald_teleshot
	...
	chosen_message = "<span class='boldwarning'>I will now fire a shot which teleports you where it lands.</span>"
	chosen_attack_num = HERALD_TELESHOT

/datum/action/innate/elite_attack/herald_mirror
	name = "Summon Mirror"
	button_icon_state = "herald_mirror"
	chosen_message = "<span class='boldwarning'>I will spawn a mirror which duplicates your attacks.</span>"
